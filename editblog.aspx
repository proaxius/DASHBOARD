<%@ Page Title="" Language="C#" MasterPageFile="~/Homepage/admin/adminMasterPage.master" AutoEventWireup="true" CodeFile="editblog.aspx.cs" Inherits="admin_Default" EnableEventValidation="false" %>
...
<div class="row">
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <asp:FileUpload ID="blogpic" runat="server" CssClass="form-control" />
        </div>
        ...
        <div class="col-md-12"><br /><br />
            ...
            <asp:TextBox ID="txt_Descriptionblog" runat="server" TextMode="MultiLine" Rows="4" CssClass="form-control teBox"></asp:TextBox>
        </div>
